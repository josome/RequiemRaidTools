...
-- Panels
local lootPanel, spielerPanel, logPanel
-- Tabs
local tabButtons = {}
...
function UI.BuildMainFrame()
    ...
    resetRaidBtn:SetSize(70, 22)
    resetRaidBtn:SetPoint("LEFT", startRaidBtn, "RIGHT", 4, 0)
    ...
    local tabNames = { "Loot", "Spieler", "Log" }
