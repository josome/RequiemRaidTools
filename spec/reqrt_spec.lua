...
dofile("src/tests/Guild_Test.lua")
dofile("src/tests/Attendance_Test.lua")
...
dofile("src/tests/Frame_Test.lua")
dofile("src/tests/Lint_Test.lua")
...
describe("ReqRT.API", function()
    ...
    expectFunction("GuildLoot.ReopenSeason")
    expectFunction("GuildLoot.SetSeasonStart")
    expectFunction("GuildLoot.DeleteSeason")
    expectFunction("GuildLoot.SetSeasonRankFilter")
    expectFunction("GuildLoot.SetSeasonRankThreshold")

    -- Guild
    expectFunction("GuildLoot.RefreshGuildRoster")
    expectFunction("GuildLoot.CheckGuildRosterCompleteness")
    expectFunction("GuildLoot.ReadGuildRosterNow")
    expectFunction("GuildLoot.CollectGuildMembers")
    expectFunction("GuildLoot.GetGuildMembers")
    expectFunction("GuildLoot.GetGuildRankNames")
    expectFunction("GuildLoot.UpdateGuildRankNames")
    expectFunction("GuildLoot.OnGuildRosterUpdate")
    expectFunction("GuildLoot.GetSeasonAttendees")
    expectFunction("GuildLoot.GetSeasonRoster")
    expectFunction("GuildLoot.SnapshotSeasonRoster")
    expectFunction("GuildLoot.IsSeasonRosterStale")

    -- Attendance
    expectFunction("GuildLoot.ComputeAttendance")
