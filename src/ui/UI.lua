...
function UI.BuildMainFrame()
    ...
    minBtn:SetSize(64, 64)
    minBtn:SetPoint("TOPLEFT", mainFrame, "TOPLEFT", -5, 27)
    minBtn:SetFrameLevel(mover:GetFrameLevel() + 2)
    minBtn:SetNormalTexture("Interface\\AddOns\\RequiemRaidTools\\Media\\icon")
    minBtn:SetHighlightTexture("Interface\\Buttons\\ButtonHilight-Round", "ADD")
    ...
    -- Drop-Panel (manuell Item hinzufügen) — implementiert in UI_DropPanel.lua
    UI.BuildDropPanel(mainFrame)
